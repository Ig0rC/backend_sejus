    ...
    async cadastrar(req, res, next) {
        ...
        try {
            ...
            //aluno
                ...
                await knex('telefone').insert({
                    id_tipo_telefone: tipo_telefone_sos, 
                    ddd: ddd_SOS, 
                    ddi: ddiSOS, 
                    numero_telefone: numero_SOS
                });
                ...
                console.log(id_acessibilidade,'acessibilidade')
                ...
                console.log(id_autonomia,'patologia')
                ...
                for (let i = 0; i < busca_id_telefone_SOS.length; i++) {
                    ...
                    await knex('aluno').insert({
                        ...
                        ultima_profissao, adm_financeira,
