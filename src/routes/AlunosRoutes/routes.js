...
AlunosRoutes.get('/aluno/minha/nota/cursos', AuthMiddlewares, AlunoController.minhaNotasFaculdade)
...
AlunosRoutes.get('/alunos/buscar/cursos', AlunoController.buscarCursos)
AlunosRoutes.get('/alunos/info/cursos/:idCurso/:idInsti', AlunoController.buscarCursosInfo)
AlunosRoutes.get('/alunos/info/disciplinas/:idCurso', AlunoController.infoCursoDisciplina)
AlunosRoutes.get('/alunos/info/turmas/:idCurso/:idInsti', AlunoController.infoCursoTurma);
